...
import {
  Heading, Flex, Text, Button, Box, Card, CardBody, StackDivider, Stack, ModalOverlay, Modal, FormLabel,
  ModalHeader,
  ModalCloseButton,
  ModalBody,
  ModalFooter,
    ...
    <>
      ...
      <Box minH="100vh">
        ...
        <Flex ml="10%" wrap="wrap">
          ...
          <Button borderRadius="20px" onClick={handlePag2} >Ver historial de solicitudes por mes</Button>
        </Flex>
        {pag === 1 ?
          <>
                ...
                {allPerm.map(perm => (
                  <Card w="48%" my="2%" key={perm.id} pb="1%">
                    ...
                    <Flex justify="space-evenly">
                      <Button colorScheme="red" onClick={() => permSeleccionado(perm, "")}>Rechazar</Button>
                      <Button colorScheme="green" onClick={() => permSeleccionado(perm, "aprobar")}>Aprobar</Button>
                      <Button colorScheme="blue" onClick={() => permSeleccionado(perm, "eliminar")}>Borrar</Button>
                    </Flex>
                  </Card>
          ...
          <Flex justify="center">
            <Card w="auto" >
              <Flex direction="column" align="center" p="20px">
                ...
                <Button colorScheme="blue" size="lg" mt="5px">Buscar</Button>
              </Flex>
            </Card>
          </Flex>
